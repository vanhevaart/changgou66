package org.changgou.oauth.service.impl;

import org.changgou.oauth.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    @Override
    public void getGitHubToken(String code) {
        String url = "https://github.com/login/oauth/access_token";
        String client_id = "30625bf8268f6bfffa38";
        String client_secret = "be981afc9800f43fbd69a44901a9f4e2d2675b6f";
        // 设置请求体
        LinkedMultiValueMap requestMap = new LinkedMultiValueMap();
        requestMap.add("code",code);
        requestMap.add("client_id",client_id);
        requestMap.add("client_secret",client_secret);
        requestMap.add("redirect_uri","http://localhost:7001");
        // 设置头信息

        HttpEntity requestEntity = new HttpEntity(requestMap);
        /*ResponseEntity<String> exchange = restTemplate.exchange(url, HttpMethod.POST, requestEntity, String.class);
        String body = exchange.getBody();
        System.out.println("GitHbu返回的token信息:"+body);
        System.out.println("========================================");
        ...
        ResponseEntity<Map> exchange1 = restTemplate.exchange(userUrl, HttpMethod.GET, entity, Map.class);
        System.out.println("返回的user信息;");
