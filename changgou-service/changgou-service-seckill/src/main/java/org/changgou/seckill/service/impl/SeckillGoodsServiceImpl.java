...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
     ...
     */
    @Override
    public SeckillGoods findByIdFromRedis(String id, String time) {
        Object object = stringRedisTemplate.boundHashOps(SeckillGoodsPushTask.SECKILLGOODS + time).get(id);
        if(object != null){
            return JSON.parseObject((String) object, SeckillGoods.class);
        }
        return null;
    }
     ...
     */
    @Override
    public List<SeckillGoods> listFromRedis(String time) {
        List<Object> values = stringRedisTemplate.boundHashOps(SeckillGoodsPushTask.SECKILLGOODS + time).values();
        // 数据转换
