...
import org.changgou.user.service.AddressService;
...
public class AddressController {
    ...
    public Result<List<Address>> findByUsername() {
        ...
        List<Address> list = addressService.findByUsername(username);
        return new Result<>(true, StatusCode.OK,"查询收货地址成功",list);
    }
